...
idVillageois = "8c0f8ada-fb55-43ed-a8f4-92f71ddf54ed"
...
def update_position(movement):
    ...
    if movement == "DEPLACEMENT_DROITE":
        char_pos[0] = min(char_pos[0] + 1, cols - 1)
    elif movement == "DEPLACEMENT_GAUCHE":
        char_pos[0] = max(char_pos[0] - 1, 0)
    elif movement == "DEPLACEMENT_HAUT":
        char_pos[1] = max(char_pos[1] - 1, 0)
    elif movement == "DEPLACEMENT_BAS":
        char_pos[1] = min(char_pos[1] + 1, cols - 1)
